                            ...
                            <div class="clearfix">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <tbody>
                                        ...
                                        <!-- deleteTypeCharge box begin-->
                                            <div id="deleteCharge<?= $type->id() ?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                    <h3>Supprimer Type Charge</h3>
                                                </div>
                                                <div class="modal-body">
                                                    <form class="form-horizontal" action="../controller/TypeChargeActionController.php" method="post">
                                                        <h4 class="dangerous-action">Etes-vous sur de vouloir supprimer ce Type Charge ?</h4>
                                                        <div class="control-group">
                                                            <div class="controls">
                                                                <input type="hidden" name="idTypeCharge" value="<?= $type->id() ?>">
