<?php
    ...
    if(isset($_SESSION['userImmoERPV2']) and $_SESSION['userImmoERPV2']->profil()=="admin"){
		...
		( $_GET['idEmploye']>0 and $_GET['idEmploye']<=$employeManager->getLastId() ) ){
			...
			$salairesManager = new EmployeSocieteSalaireManager(PDOFactory::getMysqlConnection());	
			$salaires = $salairesManager->getSalairesByIdEmploye($idEmploye);
			$congesManager = new EmployeSocieteCongeManager(PDOFactory::getMysqlConnection());
